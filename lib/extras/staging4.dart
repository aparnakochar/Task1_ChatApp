...
class _WelcomeScreenState extends State<WelcomeScreen>
  ...
  void initState() {
    ...
    animation = CurvedAnimation(
        parent: controller,
        curve: Curves.easeIn); //first increases slowly then fast
    // controller.reverse(from: 1.0); to reverse the animation
    controller.forward();
    // controller.addStatusListener((status) {
    //   print(status);//to get the status whether our animation is completed or not
    //   // if (status == AnimationStatus.completed) {     TOGGLE THE LOGO
                ...
                Hero(
                  ...
                  child: Container(
                    ...
                    height: animation.value *
                        60, //to increase the size of logo by applyng animation
                  ),
                ),
                Text(
                  'Flash Chat',
